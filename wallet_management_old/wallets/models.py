...
""" 
    Business Rules:
    - Only first 6 digits of card numbers are stored
    - Users cannot have duplicate wallets (same account_number + owner)
...
class Wallet(models.Model):
  ...
  # Scheme categories
    ...
    # Phone number validator for owner field, not to exceed 13 digits
    ...
    """
        ...
        Validates: Wallet type matches account scheme and also checks account number format is appropriate for type
        """
